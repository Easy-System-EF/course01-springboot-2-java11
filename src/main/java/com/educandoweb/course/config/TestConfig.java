...
/*
 * 		para salvar um objeto dependente numa relação 1/1
 * 		payment informando dados do pgto e a order, com associação de mão dupla em memória passando
 * 		sem repository do objeto - associação do objeto o1 com pay1, salvando o pedido
 */
